...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 67 08 00 	movl   $0x867,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 426:	0f b6 90 c4 0a 00 00 	movzbl 0xac4(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 585:	75 27                	jne    5ae <printf+0x11f>
          s = "(null)";
 587:	c7 45 f4 80 08 00 00 	movl   $0x880,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 653:	a1 e0 0a 00 00       	mov    0xae0,%eax
...
free(void *ap)
{
 ...
 714:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 719:	c9                   	leave  
 71a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 767:	e8 d8 fe ff ff       	call   644 <free>
  return freep;
 76c:	a1 e0 0a 00 00       	mov    0xae0,%eax
}
 771:	c9                   	leave  
 772:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 785:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 788:	a1 e0 0a 00 00       	mov    0xae0,%eax
 78d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 790:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 794:	75 23                	jne    7b9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 796:	c7 45 f0 d8 0a 00 00 	movl   $0xad8,-0x10(%ebp)
 79d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a0:	a3 e0 0a 00 00       	mov    %eax,0xae0
 7a5:	a1 e0 0a 00 00       	mov    0xae0,%eax
 7aa:	a3 d8 0a 00 00       	mov    %eax,0xad8
    base.s.size = 0;
 7af:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 7b6:	00 00 00 
  }
 ...
 80c:	a3 e0 0a 00 00       	mov    %eax,0xae0
      return (void*)(p + 1);
 ...
 817:	eb 38                	jmp    851 <malloc+0xde>
    ...
    if(p == freep)
 819:	a1 e0 0a 00 00       	mov    0xae0,%eax
