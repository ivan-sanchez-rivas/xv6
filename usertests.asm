...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      ...
      16:	e8 b4 3d 00 00       	call   3dcf <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
      ...
      48:	e8 82 3d 00 00       	call   3dcf <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
      ...
      8a:	e8 40 3d 00 00       	call   3dcf <printf>
    exit();
  ...
  printf(stdout, "open test ok\n");
      ...
      a4:	e8 26 3d 00 00       	call   3dcf <printf>
}
      a9:	c9                   	leave  
      aa:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
      ...
      c1:	e8 09 3d 00 00       	call   3dcf <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
      ...
      f3:	e8 d7 3c 00 00       	call   3dcf <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     114:	e8 b6 3c 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     155:	e8 75 3c 00 00       	call   3dcf <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     196:	e8 34 3c 00 00       	call   3dcf <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     1be:	e8 0c 3c 00 00       	call   3dcf <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     1fb:	e8 cf 3b 00 00       	call   3dcf <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     239:	e8 91 3b 00 00       	call   3dcf <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     253:	e8 77 3b 00 00       	call   3dcf <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     285:	e8 45 3b 00 00       	call   3dcf <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     29f:	e8 2b 3b 00 00       	call   3dcf <printf>
    exit();
  ...
  printf(stdout, "small file test ok\n");
     ...
     2b9:	e8 11 3b 00 00       	call   3dcf <printf>
}
     2be:	c9                   	leave  
     2bf:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     2d6:	e8 f4 3a 00 00       	call   3dcf <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     308:	e8 c2 3a 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     35e:	e8 6c 3a 00 00       	call   3dcf <printf>
      exit();
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     3ae:	e8 1c 3a 00 00       	call   3dcf <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     3f0:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     3f5:	8b 55 f0             	mov    -0x10(%ebp),%edx
     3f8:	89 54 24 08          	mov    %edx,0x8(%esp)
     3fc:	c7 44 24 04 9d 43 00 	movl   $0x439d,0x4(%esp)
     403:	00 
     404:	89 04 24             	mov    %eax,(%esp)
     407:	e8 c3 39 00 00       	call   3dcf <printf>
        exit();
     ...
     41a:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     41f:	8b 55 f4             	mov    -0xc(%ebp),%edx
     422:	89 54 24 08          	mov    %edx,0x8(%esp)
     426:	c7 44 24 04 ba 43 00 	movl   $0x43ba,0x4(%esp)
     42d:	00 
     42e:	89 04 24             	mov    %eax,(%esp)
     431:	e8 99 39 00 00       	call   3dcf <printf>
      exit();
  ...
  if(unlink("big") < 0){
     488:	c7 04 24 48 43 00 00 	movl   $0x4348,(%esp)
     48f:	e8 e4 37 00 00       	call   3c78 <unlink>
     494:	85 c0                	test   %eax,%eax
     496:	79 1a                	jns    4b2 <writetest1+0x1f2>
    printf(stdout, "unlink big failed\n");
     498:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     49d:	c7 44 24 04 ec 43 00 	movl   $0x43ec,0x4(%esp)
     4a4:	00 
     4a5:	89 04 24             	mov    %eax,(%esp)
     4a8:	e8 22 39 00 00       	call   3dcf <printf>
    exit();
     4ad:	e8 76 37 00 00       	call   3c28 <exit>
  }
  printf(stdout, "big files ok\n");
     4b2:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     4b7:	c7 44 24 04 ff 43 00 	movl   $0x43ff,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 08 39 00 00       	call   3dcf <printf>
}
     4c7:	c9                   	leave  
     4c8:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     4cf:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     4d4:	c7 44 24 04 10 44 00 	movl   $0x4410,0x4(%esp)
     4db:	00 
     4dc:	89 04 24             	mov    %eax,(%esp)
     4df:	e8 eb 38 00 00       	call   3dcf <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     56a:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     56f:	c7 44 24 04 38 44 00 	movl   $0x4438,0x4(%esp)
     576:	00 
     577:	89 04 24             	mov    %eax,(%esp)
     57a:	e8 50 38 00 00       	call   3dcf <printf>
}
     57f:	c9                   	leave  
     580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     587:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     58c:	c7 44 24 04 5e 44 00 	movl   $0x445e,0x4(%esp)
     593:	00 
     594:	89 04 24             	mov    %eax,(%esp)
     597:	e8 33 38 00 00       	call   3dcf <printf>

  if(mkdir("dir0") < 0){
     59c:	c7 04 24 6a 44 00 00 	movl   $0x446a,(%esp)
     5a3:	e8 e8 36 00 00       	call   3c90 <mkdir>
     5a8:	85 c0                	test   %eax,%eax
     5aa:	79 1a                	jns    5c6 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     5ac:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     5b1:	c7 44 24 04 6f 44 00 	movl   $0x446f,0x4(%esp)
     5b8:	00 
     5b9:	89 04 24             	mov    %eax,(%esp)
     5bc:	e8 0e 38 00 00       	call   3dcf <printf>
    exit();
     5c1:	e8 62 36 00 00       	call   3c28 <exit>
  }

  if(chdir("dir0") < 0){
     5c6:	c7 04 24 6a 44 00 00 	movl   $0x446a,(%esp)
     5cd:	e8 c6 36 00 00       	call   3c98 <chdir>
     5d2:	85 c0                	test   %eax,%eax
     5d4:	79 1a                	jns    5f0 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     5d6:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     5db:	c7 44 24 04 7d 44 00 	movl   $0x447d,0x4(%esp)
     5e2:	00 
     5e3:	89 04 24             	mov    %eax,(%esp)
     5e6:	e8 e4 37 00 00       	call   3dcf <printf>
    exit();
     5eb:	e8 38 36 00 00       	call   3c28 <exit>
  }

  if(chdir("..") < 0){
     5f0:	c7 04 24 90 44 00 00 	movl   $0x4490,(%esp)
     5f7:	e8 9c 36 00 00       	call   3c98 <chdir>
     5fc:	85 c0                	test   %eax,%eax
     5fe:	79 1a                	jns    61a <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     600:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     605:	c7 44 24 04 93 44 00 	movl   $0x4493,0x4(%esp)
     60c:	00 
     60d:	89 04 24             	mov    %eax,(%esp)
     610:	e8 ba 37 00 00       	call   3dcf <printf>
    exit();
     615:	e8 0e 36 00 00       	call   3c28 <exit>
  }

  if(unlink("dir0") < 0){
     61a:	c7 04 24 6a 44 00 00 	movl   $0x446a,(%esp)
     621:	e8 52 36 00 00       	call   3c78 <unlink>
     626:	85 c0                	test   %eax,%eax
     628:	79 1a                	jns    644 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     62a:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     62f:	c7 44 24 04 a4 44 00 	movl   $0x44a4,0x4(%esp)
     636:	00 
     637:	89 04 24             	mov    %eax,(%esp)
     63a:	e8 90 37 00 00       	call   3dcf <printf>
    exit();
     63f:	e8 e4 35 00 00       	call   3c28 <exit>
  }
  printf(stdout, "mkdir test\n");
     644:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     649:	c7 44 24 04 5e 44 00 	movl   $0x445e,0x4(%esp)
     650:	00 
     651:	89 04 24             	mov    %eax,(%esp)
     654:	e8 76 37 00 00       	call   3dcf <printf>
}
     659:	c9                   	leave  
     65a:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     661:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     666:	c7 44 24 04 b8 44 00 	movl   $0x44b8,0x4(%esp)
     66d:	00 
     66e:	89 04 24             	mov    %eax,(%esp)
     671:	e8 59 37 00 00       	call   3dcf <printf>
  if(exec("echo", echoargv) < 0){
     676:	c7 44 24 04 d8 5e 00 	movl   $0x5ed8,0x4(%esp)
     67d:	00 
     67e:	c7 04 24 94 41 00 00 	movl   $0x4194,(%esp)
     685:	e8 d6 35 00 00       	call   3c60 <exec>
     68a:	85 c0                	test   %eax,%eax
     68c:	79 1a                	jns    6a8 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     68e:	a1 ec 5e 00 00       	mov    0x5eec,%eax
     693:	c7 44 24 04 c3 44 00 	movl   $0x44c3,0x4(%esp)
     69a:	00 
     69b:	89 04 24             	mov    %eax,(%esp)
     69e:	e8 2c 37 00 00       	call   3dcf <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     6bf:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
     6c6:	00 
     6c7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     6ce:	e8 fc 36 00 00       	call   3dcf <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     74f:	c7 44 24 04 e4 44 00 	movl   $0x44e4,0x4(%esp)
     756:	00 
     757:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     75e:	e8 6c 36 00 00       	call   3dcf <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     7c8:	c7 44 24 04 f2 44 00 	movl   $0x44f2,0x4(%esp)
     7cf:	00 
     7d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     7d7:	e8 f3 35 00 00       	call   3dcf <printf>
          return;
    ...
    if(total != 5 * 1033){
     ...
     83e:	c7 44 24 04 00 45 00 	movl   $0x4500,0x4(%esp)
     845:	00 
     846:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     84d:	e8 7d 35 00 00       	call   3dcf <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     867:	c7 44 24 04 17 45 00 	movl   $0x4517,0x4(%esp)
     86e:	00 
     86f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     876:	e8 54 35 00 00       	call   3dcf <printf>
    ...
    printf(1, "fork() failed\n");
     87d:	c7 44 24 04 21 45 00 	movl   $0x4521,0x4(%esp)
     884:	00 
     885:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     88c:	e8 3e 35 00 00       	call   3dcf <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     89e:	c7 44 24 04 30 45 00 	movl   $0x4530,0x4(%esp)
     8a5:	00 
     8a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     8ad:	e8 1d 35 00 00       	call   3dcf <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     900:	00 
     901:	c7 44 24 04 3a 45 00 	movl   $0x453a,0x4(%esp)
     908:	00 
     ...
     916:	c7 44 24 04 3c 45 00 	movl   $0x453c,0x4(%esp)
     91d:	00 
     91e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     925:	e8 a5 34 00 00       	call   3dcf <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     962:	c7 44 24 04 50 45 00 	movl   $0x4550,0x4(%esp)
     969:	00 
     96a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     971:	e8 59 34 00 00       	call   3dcf <printf>
    return;
  ...
  printf(1, "kill... ");
     983:	c7 44 24 04 63 45 00 	movl   $0x4563,0x4(%esp)
     98a:	00 
     98b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     992:	e8 38 34 00 00       	call   3dcf <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     9b8:	c7 44 24 04 6c 45 00 	movl   $0x456c,0x4(%esp)
     9bf:	00 
     9c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9c7:	e8 03 34 00 00       	call   3dcf <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     9db:	c7 44 24 04 75 45 00 	movl   $0x4575,0x4(%esp)
     9e2:	00 
     9e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9ea:	e8 e0 33 00 00       	call   3dcf <printf>
}
     9ef:	c9                   	leave  
     9f0:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     a0c:	79 16                	jns    a24 <exitwait+0x33>
      printf(1, "fork failed\n");
     a0e:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
     a15:	00 
     a16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a1d:	e8 ad 33 00 00       	call   3dcf <printf>
      return;
    ...
    if(pid){
     ...
     a34:	c7 44 24 04 8e 45 00 	movl   $0x458e,0x4(%esp)
     a3b:	00 
     a3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a43:	e8 87 33 00 00       	call   3dcf <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     a59:	c7 44 24 04 9e 45 00 	movl   $0x459e,0x4(%esp)
     a60:	00 
     a61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a68:	e8 62 33 00 00       	call   3dcf <printf>
}
     a6d:	c9                   	leave  
     a6e:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     a75:	c7 44 24 04 ab 45 00 	movl   $0x45ab,0x4(%esp)
     a7c:	00 
     a7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a84:	e8 46 33 00 00       	call   3dcf <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ac1:	e8 ed 35 00 00       	call   40b3 <malloc>
    ...
    while(m1){
     ...
     adf:	e8 a0 34 00 00       	call   3f84 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     b2f:	e8 50 34 00 00       	call   3f84 <free>
    printf(1, "mem ok\n");
     b34:	c7 44 24 04 cf 45 00 	movl   $0x45cf,0x4(%esp)
     b3b:	00 
     b3c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b43:	e8 87 32 00 00       	call   3dcf <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     b5a:	c7 44 24 04 d7 45 00 	movl   $0x45d7,0x4(%esp)
     b61:	00 
     b62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b69:	e8 61 32 00 00       	call   3dcf <printf>

  unlink("sharedfd");
     b6e:	c7 04 24 e6 45 00 00 	movl   $0x45e6,(%esp)
     b75:	e8 fe 30 00 00       	call   3c78 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     b7a:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     b81:	00 
     b82:	c7 04 24 e6 45 00 00 	movl   $0x45e6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     b97:	c7 44 24 04 f0 45 00 	movl   $0x45f0,0x4(%esp)
     b9e:	00 
     b9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ba6:	e8 24 32 00 00       	call   3dcf <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     c09:	c7 44 24 04 1c 46 00 	movl   $0x461c,0x4(%esp)
     c10:	00 
     c11:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c18:	e8 b2 31 00 00       	call   3dcf <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     c4e:	00 
     c4f:	c7 04 24 e6 45 00 00 	movl   $0x45e6,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     c64:	c7 44 24 04 3c 46 00 	movl   $0x463c,0x4(%esp)
     c6b:	00 
     c6c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c73:	e8 57 31 00 00       	call   3dcf <printf>
    return;
  ...
  unlink("sharedfd");
     cf1:	c7 04 24 e6 45 00 00 	movl   $0x45e6,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     d0f:	c7 44 24 04 67 46 00 	movl   $0x4667,0x4(%esp)
     d16:	00 
     d17:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d1e:	e8 ac 30 00 00       	call   3dcf <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     d33:	c7 44 24 04 74 46 00 	movl   $0x4674,0x4(%esp)
     d3a:	00 
     d3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d42:	e8 88 30 00 00       	call   3dcf <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
     d54:	c7 44 24 04 89 46 00 	movl   $0x4689,0x4(%esp)
     d5b:	00 
     d5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d63:	e8 67 30 00 00       	call   3dcf <printf>

  unlink("f1");
     d68:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
     d6f:	e8 04 2f 00 00       	call   3c78 <unlink>
  unlink("f2");
     d74:	c7 04 24 9b 46 00 00 	movl   $0x469b,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     d8e:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
     d95:	00 
     d96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d9d:	e8 2d 30 00 00       	call   3dcf <printf>
    exit();
  ...
  fname = pid ? "f1" : "f2";
     ...
     dad:	b8 98 46 00 00       	mov    $0x4698,%eax
     db2:	eb 05                	jmp    db9 <twofiles+0x6b>
     db4:	b8 9b 46 00 00       	mov    $0x469b,%eax
  ...
  if(fd < 0){
    ...
    printf(1, "create failed\n");
     dd8:	c7 44 24 04 9e 46 00 	movl   $0x469e,0x4(%esp)
     ddf:	00 
     de0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     de7:	e8 e3 2f 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < 12; i++){
    ...
    if((n = write(fd, buf, 500)) != 500){
     ...
     e52:	c7 44 24 04 ad 46 00 	movl   $0x46ad,0x4(%esp)
     e59:	00 
     e5a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e61:	e8 69 2f 00 00       	call   3dcf <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    fd = open(i?"f1":"f2", 0);
     ...
     ea2:	b8 98 46 00 00       	mov    $0x4698,%eax
     ea7:	eb 05                	jmp    eae <twofiles+0x160>
     ea9:	b8 9b 46 00 00       	mov    $0x469b,%eax
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     ef5:	74 19                	je     f10 <twofiles+0x1c2>
          printf(1, "wrong char\n");
     ef7:	c7 44 24 04 be 46 00 	movl   $0x46be,0x4(%esp)
     efe:	00 
     eff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f06:	e8 c4 2e 00 00       	call   3dcf <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
     ...
     f61:	c7 44 24 04 ca 46 00 	movl   $0x46ca,0x4(%esp)
     f68:	00 
     f69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f70:	e8 5a 2e 00 00       	call   3dcf <printf>
      exit();
  ...
  unlink("f1");
     f88:	c7 04 24 98 46 00 00 	movl   $0x4698,(%esp)
     f8f:	e8 e4 2c 00 00       	call   3c78 <unlink>
  unlink("f2");
     f94:	c7 04 24 9b 46 00 00 	movl   $0x469b,(%esp)
     f9b:	e8 d8 2c 00 00       	call   3c78 <unlink>

  printf(1, "twofiles ok\n");
     fa0:	c7 44 24 04 db 46 00 	movl   $0x46db,0x4(%esp)
     fa7:	00 
     fa8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     faf:	e8 1b 2e 00 00       	call   3dcf <printf>
}
     fb4:	c9                   	leave  
     fb5:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     fbc:	c7 44 24 04 e8 46 00 	movl   $0x46e8,0x4(%esp)
     fc3:	00 
     fc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fcb:	e8 ff 2d 00 00       	call   3dcf <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
     fde:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
     fe5:	00 
     fe6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fed:	e8 dd 2d 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    103f:	79 19                	jns    105a <createdelete+0xa4>
      printf(1, "create failed\n");
    1041:	c7 44 24 04 9e 46 00 	movl   $0x469e,0x4(%esp)
    1048:	00 
    1049:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1050:	e8 7a 2d 00 00       	call   3dcf <printf>
      exit();
    ...
    1096:	c7 44 24 04 fb 46 00 	movl   $0x46fb,0x4(%esp)
    109d:	00 
    109e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10a5:	e8 25 2d 00 00       	call   3dcf <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1115:	c7 44 24 04 0c 47 00 	movl   $0x470c,0x4(%esp)
    111c:	00 
    111d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1124:	e8 a6 2c 00 00       	call   3dcf <printf>
      exit();
    ...
    1147:	c7 44 24 04 30 47 00 	movl   $0x4730,0x4(%esp)
    114e:	00 
    114f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1156:	e8 74 2c 00 00       	call   3dcf <printf>
      exit();
    ...
    11ad:	c7 44 24 04 0c 47 00 	movl   $0x470c,0x4(%esp)
    11b4:	00 
    11b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11bc:	e8 0e 2c 00 00       	call   3dcf <printf>
      exit();
    ...
    11df:	c7 44 24 04 30 47 00 	movl   $0x4730,0x4(%esp)
    11e6:	00 
    11e7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11ee:	e8 dc 2b 00 00       	call   3dcf <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    1251:	c7 44 24 04 50 47 00 	movl   $0x4750,0x4(%esp)
    1258:	00 
    1259:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1260:	e8 6a 2b 00 00       	call   3dcf <printf>
}
    1265:	c9                   	leave  
    1266:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    126d:	c7 44 24 04 61 47 00 	movl   $0x4761,0x4(%esp)
    1274:	00 
    1275:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127c:	e8 4e 2b 00 00       	call   3dcf <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1281:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1288:	00 
    1289:	c7 04 24 72 47 00 00 	movl   $0x4772,(%esp)
  ...
  if(fd < 0){
    ...
    129e:	c7 44 24 04 7d 47 00 	movl   $0x477d,0x4(%esp)
    12a5:	00 
    12a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12ad:	e8 1d 2b 00 00       	call   3dcf <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    12be:	00 
    12bf:	c7 44 24 04 97 47 00 	movl   $0x4797,0x4(%esp)
    12c6:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    12e4:	00 
    12e5:	c7 04 24 72 47 00 00 	movl   $0x4772,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1399:	c7 44 24 04 d3 47 00 	movl   $0x47d3,0x4(%esp)
    13a0:	00 
    13a1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13a8:	e8 22 2a 00 00       	call   3dcf <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    13bd:	c7 44 24 04 ea 47 00 	movl   $0x47ea,0x4(%esp)
    13c4:	00 
    13c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    13cc:	e8 fe 29 00 00       	call   3dcf <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    13f6:	c7 44 24 04 01 48 00 	movl   $0x4801,0x4(%esp)
    13fd:	00 
    13fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1405:	e8 c5 29 00 00       	call   3dcf <printf>
    exit();
  ...
  unlink("unlinkread");
    141a:	c7 04 24 72 47 00 00 	movl   $0x4772,(%esp)
    1421:	e8 52 28 00 00       	call   3c78 <unlink>
  printf(1, "unlinkread ok\n");
    1426:	c7 44 24 04 1a 48 00 	movl   $0x481a,0x4(%esp)
    142d:	00 
    142e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1435:	e8 95 29 00 00       	call   3dcf <printf>
}
    143a:	c9                   	leave  
    143b:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    1442:	c7 44 24 04 29 48 00 	movl   $0x4829,0x4(%esp)
    1449:	00 
    144a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1451:	e8 79 29 00 00       	call   3dcf <printf>

  unlink("lf1");
    1456:	c7 04 24 33 48 00 00 	movl   $0x4833,(%esp)
    145d:	e8 16 28 00 00       	call   3c78 <unlink>
  unlink("lf2");
    1462:	c7 04 24 37 48 00 00 	movl   $0x4837,(%esp)
    1469:	e8 0a 28 00 00       	call   3c78 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    146e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1475:	00 
    1476:	c7 04 24 33 48 00 00 	movl   $0x4833,(%esp)
  ...
  if(fd < 0){
    ...
    148b:	c7 44 24 04 3b 48 00 	movl   $0x483b,0x4(%esp)
    1492:	00 
    1493:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    149a:	e8 30 29 00 00       	call   3dcf <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    14ab:	00 
    14ac:	c7 44 24 04 97 47 00 	movl   $0x4797,0x4(%esp)
    14b3:	00 
    ...
    14c4:	c7 44 24 04 4e 48 00 	movl   $0x484e,0x4(%esp)
    14cb:	00 
    14cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14d3:	e8 f7 28 00 00       	call   3dcf <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    155d:	00 
    155e:	c7 04 24 37 48 00 00 	movl   $0x4837,(%esp)
  ...
  if(fd < 0){
    ...
    1573:	c7 44 24 04 9d 48 00 	movl   $0x489d,0x4(%esp)
    157a:	00 
    157b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1582:	e8 48 28 00 00       	call   3dcf <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    15ac:	c7 44 24 04 ae 48 00 	movl   $0x48ae,0x4(%esp)
    15b3:	00 
    15b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15bb:	e8 0f 28 00 00       	call   3dcf <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    15d0:	c7 44 24 04 37 48 00 	movl   $0x4837,0x4(%esp)
    15d7:	00 
    15d8:	c7 04 24 37 48 00 00 	movl   $0x4837,(%esp)
    15df:	e8 a4 26 00 00       	call   3c88 <link>
    15e4:	85 c0                	test   %eax,%eax
    15e6:	78 19                	js     1601 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    15e8:	c7 44 24 04 bf 48 00 	movl   $0x48bf,0x4(%esp)
    15ef:	00 
    15f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    15f7:	e8 d3 27 00 00       	call   3dcf <printf>
    exit();
    15fc:	e8 27 26 00 00       	call   3c28 <exit>
  }

  unlink("lf2");
    1601:	c7 04 24 37 48 00 00 	movl   $0x4837,(%esp)
    1608:	e8 6b 26 00 00       	call   3c78 <unlink>
  if(link("lf2", "lf1") >= 0){
    160d:	c7 44 24 04 33 48 00 	movl   $0x4833,0x4(%esp)
    1614:	00 
    1615:	c7 04 24 37 48 00 00 	movl   $0x4837,(%esp)
    161c:	e8 67 26 00 00       	call   3c88 <link>
    1621:	85 c0                	test   %eax,%eax
    1623:	78 19                	js     163e <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    1625:	c7 44 24 04 e0 48 00 	movl   $0x48e0,0x4(%esp)
    162c:	00 
    162d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1634:	e8 96 27 00 00       	call   3dcf <printf>
    exit();
    1639:	e8 ea 25 00 00       	call   3c28 <exit>
  }

  if(link(".", "lf1") >= 0){
    163e:	c7 44 24 04 33 48 00 	movl   $0x4833,0x4(%esp)
    1645:	00 
    1646:	c7 04 24 03 49 00 00 	movl   $0x4903,(%esp)
    164d:	e8 36 26 00 00       	call   3c88 <link>
    1652:	85 c0                	test   %eax,%eax
    1654:	78 19                	js     166f <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    1656:	c7 44 24 04 05 49 00 	movl   $0x4905,0x4(%esp)
    165d:	00 
    165e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1665:	e8 65 27 00 00       	call   3dcf <printf>
    exit();
    166a:	e8 b9 25 00 00       	call   3c28 <exit>
  }

  printf(1, "linktest ok\n");
    166f:	c7 44 24 04 21 49 00 	movl   $0x4921,0x4(%esp)
    1676:	00 
    1677:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    167e:	e8 4c 27 00 00       	call   3dcf <printf>
}
    1683:	c9                   	leave  
    1684:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    168b:	c7 44 24 04 2e 49 00 	movl   $0x492e,0x4(%esp)
    1692:	00 
    1693:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    169a:	e8 30 27 00 00       	call   3dcf <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16fe:	c7 04 24 3e 49 00 00 	movl   $0x493e,(%esp)
    ...
    1741:	c7 04 24 3e 49 00 00 	movl   $0x493e,(%esp)
    ...
    1772:	c7 44 24 04 41 49 00 	movl   $0x4941,0x4(%esp)
    1779:	00 
    177a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1781:	e8 49 26 00 00       	call   3dcf <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    17d6:	00 
    17d7:	c7 04 24 03 49 00 00 	movl   $0x4903,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1838:	c7 44 24 04 5d 49 00 	movl   $0x495d,0x4(%esp)
    183f:	00 
    1840:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1847:	e8 83 25 00 00       	call   3dcf <printf>
        exit();
    ...
    1868:	c7 44 24 04 76 49 00 	movl   $0x4976,0x4(%esp)
    186f:	00 
    1870:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1877:	e8 53 25 00 00       	call   3dcf <printf>
        exit();
  ...
  if(n != 40){
    ...
    18c4:	c7 44 24 04 94 49 00 	movl   $0x4994,0x4(%esp)
    18cb:	00 
    18cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18d3:	e8 f7 24 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    18fe:	79 19                	jns    1919 <concreate+0x294>
      printf(1, "fork failed\n");
    1900:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
    1907:	00 
    1908:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190f:	e8 bb 24 00 00       	call   3dcf <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a20:	c7 44 24 04 c5 49 00 	movl   $0x49c5,0x4(%esp)
    1a27:	00 
    1a28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a2f:	e8 9b 23 00 00       	call   3dcf <printf>
}
    1a34:	c9                   	leave  
    1a35:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a3c:	c7 44 24 04 d3 49 00 	movl   $0x49d3,0x4(%esp)
    1a43:	00 
    1a44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a4b:	e8 7f 23 00 00       	call   3dcf <printf>

  unlink("x");
    1a50:	c7 04 24 3a 45 00 00 	movl   $0x453a,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a6a:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
    1a71:	00 
    1a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a79:	e8 51 23 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ad8:	00 
    1ad9:	c7 04 24 3a 45 00 00 	movl   $0x453a,(%esp)
    ...
    1b0a:	75 16                	jne    1b22 <linkunlink+0xec>
      link("cat", "x");
    1b0c:	c7 44 24 04 3a 45 00 	movl   $0x453a,0x4(%esp)
    1b13:	00 
    1b14:	c7 04 24 e4 49 00 00 	movl   $0x49e4,(%esp)
    1b1b:	e8 68 21 00 00       	call   3c88 <link>
    1b20:	eb 0c                	jmp    1b2e <linkunlink+0xf8>
    } else {
      unlink("x");
    1b22:	c7 04 24 3a 45 00 00 	movl   $0x453a,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b47:	c7 44 24 04 e8 49 00 	movl   $0x49e8,0x4(%esp)
    1b4e:	00 
    1b4f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b56:	e8 74 22 00 00       	call   3dcf <printf>
}
    1b5b:	c9                   	leave  
    1b5c:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1b68:	c7 44 24 04 f7 49 00 	movl   $0x49f7,0x4(%esp)
    1b6f:	00 
    1b70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b77:	e8 53 22 00 00       	call   3dcf <printf>
  unlink("bd");
    1b7c:	c7 04 24 04 4a 00 00 	movl   $0x4a04,(%esp)
    1b83:	e8 f0 20 00 00       	call   3c78 <unlink>

  fd = open("bd", O_CREATE);
    1b88:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1b8f:	00 
    1b90:	c7 04 24 04 4a 00 00 	movl   $0x4a04,(%esp)
  ...
  if(fd < 0){
    ...
    1ba5:	c7 44 24 04 07 4a 00 	movl   $0x4a07,0x4(%esp)
    1bac:	00 
    1bad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1bb4:	e8 16 22 00 00       	call   3dcf <printf>
    exit();
  ...
  unlink("bd");
    1c43:	c7 04 24 04 4a 00 00 	movl   $0x4a04,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c9b:	c7 44 24 04 31 4a 00 	movl   $0x4a31,0x4(%esp)
    1ca2:	00 
    1ca3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1caa:	e8 20 21 00 00       	call   3dcf <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1cc1:	c7 44 24 04 46 4a 00 	movl   $0x4a46,0x4(%esp)
    1cc8:	00 
    1cc9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd0:	e8 fa 20 00 00       	call   3dcf <printf>
}
    1cd5:	c9                   	leave  
    1cd6:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1cdd:	c7 44 24 04 51 4a 00 	movl   $0x4a51,0x4(%esp)
    1ce4:	00 
    1ce5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cec:	e8 de 20 00 00       	call   3dcf <printf>

  unlink("ff");
    1cf1:	c7 04 24 5e 4a 00 00 	movl   $0x4a5e,(%esp)
    1cf8:	e8 7b 1f 00 00       	call   3c78 <unlink>
  if(mkdir("dd") != 0){
    1cfd:	c7 04 24 61 4a 00 00 	movl   $0x4a61,(%esp)
    1d04:	e8 87 1f 00 00       	call   3c90 <mkdir>
    1d09:	85 c0                	test   %eax,%eax
    1d0b:	74 19                	je     1d26 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1d0d:	c7 44 24 04 64 4a 00 	movl   $0x4a64,0x4(%esp)
    1d14:	00 
    1d15:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d1c:	e8 ae 20 00 00       	call   3dcf <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d2d:	00 
    1d2e:	c7 04 24 7c 4a 00 00 	movl   $0x4a7c,(%esp)
  ...
  if(fd < 0){
    ...
    1d43:	c7 44 24 04 82 4a 00 	movl   $0x4a82,0x4(%esp)
    1d4a:	00 
    1d4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d52:	e8 78 20 00 00       	call   3dcf <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d63:	00 
    1d64:	c7 44 24 04 5e 4a 00 	movl   $0x4a5e,0x4(%esp)
    1d6b:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ddb:	00 
    1ddc:	c7 04 24 e0 4a 00 00 	movl   $0x4ae0,(%esp)
  ...
  if(fd < 0){
    ...
    1df1:	c7 44 24 04 e9 4a 00 	movl   $0x4ae9,0x4(%esp)
    1df8:	00 
    1df9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e00:	e8 ca 1f 00 00       	call   3dcf <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1e11:	00 
    1e12:	c7 44 24 04 01 4b 00 	movl   $0x4b01,0x4(%esp)
    1e19:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1e37:	00 
    1e38:	c7 04 24 04 4b 00 00 	movl   $0x4b04,(%esp)
  ...
  if(fd < 0){
    ...
    1e4d:	c7 44 24 04 10 4b 00 	movl   $0x4b10,0x4(%esp)
    1e54:	00 
    1e55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e5c:	e8 6e 1f 00 00       	call   3dcf <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e95:	c7 44 24 04 29 4b 00 	movl   $0x4b29,0x4(%esp)
    1e9c:	00 
    1e9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ea4:	e8 26 1f 00 00       	call   3dcf <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1fef:	00 
    1ff0:	c7 04 24 44 4b 00 00 	movl   $0x4b44,(%esp)
  ...
  if(fd < 0){
    ...
    2005:	c7 44 24 04 0e 4c 00 	movl   $0x4c0e,0x4(%esp)
    200c:	00 
    200d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2014:	e8 b6 1d 00 00       	call   3dcf <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    203e:	c7 44 24 04 26 4c 00 	movl   $0x4c26,0x4(%esp)
    2045:	00 
    2046:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    204d:	e8 7d 1d 00 00       	call   3dcf <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2423:	c7 44 24 04 a0 4e 00 	movl   $0x4ea0,0x4(%esp)
    242a:	00 
    242b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2432:	e8 98 19 00 00       	call   3dcf <printf>

  unlink("bigwrite");
    2437:	c7 04 24 af 4e 00 00 	movl   $0x4eaf,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    2456:	00 
    2457:	c7 04 24 af 4e 00 00 	movl   $0x4eaf,(%esp)
    ...
    246c:	c7 44 24 04 b8 4e 00 	movl   $0x4eb8,0x4(%esp)
    2473:	00 
    2474:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    247b:	e8 4f 19 00 00       	call   3dcf <printf>
      exit();
    ...
    24c1:	c7 44 24 04 d0 4e 00 	movl   $0x4ed0,0x4(%esp)
    24c8:	00 
    24c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24d0:	e8 fa 18 00 00       	call   3dcf <printf>
        exit();
    ...
    unlink("bigwrite");
    24ef:	c7 04 24 af 4e 00 00 	movl   $0x4eaf,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    250f:	c7 44 24 04 e2 4e 00 	movl   $0x4ee2,0x4(%esp)
    2516:	00 
    2517:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    251e:	e8 ac 18 00 00       	call   3dcf <printf>
}
    2523:	c9                   	leave  
    2524:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    252b:	c7 44 24 04 ef 4e 00 	movl   $0x4eef,0x4(%esp)
    2532:	00 
    2533:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    253a:	e8 90 18 00 00       	call   3dcf <printf>

  unlink("bigfile");
    253f:	c7 04 24 fd 4e 00 00 	movl   $0x4efd,(%esp)
    2546:	e8 2d 17 00 00       	call   3c78 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    254b:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    2552:	00 
    2553:	c7 04 24 fd 4e 00 00 	movl   $0x4efd,(%esp)
  ...
  if(fd < 0){
    ...
    2568:	c7 44 24 04 05 4f 00 	movl   $0x4f05,0x4(%esp)
    256f:	00 
    2570:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2577:	e8 53 18 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    25c7:	c7 44 24 04 1b 4f 00 	movl   $0x4f1b,0x4(%esp)
    25ce:	00 
    25cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25d6:	e8 f4 17 00 00       	call   3dcf <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    25fc:	00 
    25fd:	c7 04 24 fd 4e 00 00 	movl   $0x4efd,(%esp)
  ...
  if(fd < 0){
    ...
    2612:	c7 44 24 04 31 4f 00 	movl   $0x4f31,0x4(%esp)
    2619:	00 
    261a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2621:	e8 a9 17 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    265d:	c7 44 24 04 46 4f 00 	movl   $0x4f46,0x4(%esp)
    2664:	00 
    2665:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    266c:	e8 5e 17 00 00       	call   3dcf <printf>
      exit();
    ...
    2685:	c7 44 24 04 5b 4f 00 	movl   $0x4f5b,0x4(%esp)
    268c:	00 
    268d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2694:	e8 36 17 00 00       	call   3dcf <printf>
      exit();
    ...
    26d2:	c7 44 24 04 6f 4f 00 	movl   $0x4f6f,0x4(%esp)
    26d9:	00 
    26da:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26e1:	e8 e9 16 00 00       	call   3dcf <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    270f:	c7 44 24 04 88 4f 00 	movl   $0x4f88,0x4(%esp)
    2716:	00 
    2717:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    271e:	e8 ac 16 00 00       	call   3dcf <printf>
    exit();
    2723:	e8 00 15 00 00       	call   3c28 <exit>
  }
  unlink("bigfile");
    2728:	c7 04 24 fd 4e 00 00 	movl   $0x4efd,(%esp)
    272f:	e8 44 15 00 00       	call   3c78 <unlink>

  printf(1, "bigfile test ok\n");
    2734:	c7 44 24 04 a2 4f 00 	movl   $0x4fa2,0x4(%esp)
    273b:	00 
    273c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2743:	e8 87 16 00 00       	call   3dcf <printf>
}
    2748:	c9                   	leave  
    2749:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    27bd:	00 
    27be:	c7 04 24 40 50 00 00 	movl   $0x5040,(%esp)
  ...
  if(fd < 0){
    ...
    27d3:	c7 44 24 04 70 50 00 	movl   $0x5070,0x4(%esp)
    27da:	00 
    27db:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27e2:	e8 e8 15 00 00       	call   3dcf <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    27fe:	00 
    27ff:	c7 04 24 b0 50 00 00 	movl   $0x50b0,(%esp)
  ...
  if(fd < 0){
    ...
    2814:	c7 44 24 04 e0 50 00 	movl   $0x50e0,0x4(%esp)
    281b:	00 
    281c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2823:	e8 a7 15 00 00       	call   3dcf <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2a1e:	c7 44 24 04 89 52 00 	movl   $0x5289,0x4(%esp)
    2a25:	00 
    2a26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a2d:	e8 9d 13 00 00       	call   3dcf <printf>

  fd = open("dirfile", O_CREATE);
    2a32:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2a39:	00 
    2a3a:	c7 04 24 96 52 00 00 	movl   $0x5296,(%esp)
  ...
  if(fd < 0){
    ...
    2a4f:	c7 44 24 04 9e 52 00 	movl   $0x529e,0x4(%esp)
    2a56:	00 
    2a57:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a5e:	e8 6c 13 00 00       	call   3dcf <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2aa3:	00 
    2aa4:	c7 04 24 cf 52 00 00 	movl   $0x52cf,(%esp)
  ...
  if(fd >= 0){
    ...
    2ab9:	c7 44 24 04 da 52 00 	movl   $0x52da,0x4(%esp)
    2ac0:	00 
    2ac1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ac8:	e8 02 13 00 00       	call   3dcf <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2ad9:	00 
    2ada:	c7 04 24 cf 52 00 00 	movl   $0x52cf,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2bbb:	00 
    2bbc:	c7 04 24 03 49 00 00 	movl   $0x4903,(%esp)
  ...
  if(fd >= 0){
    ...
    2bd1:	c7 44 24 04 74 53 00 	movl   $0x5374,0x4(%esp)
    2bd8:	00 
    2bd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2be0:	e8 ea 11 00 00       	call   3dcf <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2c20:	c7 44 24 04 93 53 00 	movl   $0x5393,0x4(%esp)
    2c27:	00 
    2c28:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c2f:	e8 9b 11 00 00       	call   3dcf <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2c44:	c7 44 24 04 a7 53 00 	movl   $0x53a7,0x4(%esp)
    2c4b:	00 
    2c4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c53:	e8 77 11 00 00       	call   3dcf <printf>
}
    2c58:	c9                   	leave  
    2c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2c60:	c7 44 24 04 b7 53 00 	movl   $0x53b7,0x4(%esp)
    2c67:	00 
    2c68:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c6f:	e8 5b 11 00 00       	call   3dcf <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2d21:	00 
    2d22:	c7 04 24 f7 53 00 00 	movl   $0x53f7,(%esp)
    ...
    unlink("xx");
    2d42:	c7 04 24 f7 53 00 00 	movl   $0x53f7,(%esp)
  ...
  chdir("/");
    2d5c:	c7 04 24 1a 52 00 00 	movl   $0x521a,(%esp)
    2d63:	e8 30 0f 00 00       	call   3c98 <chdir>
  printf(1, "empty file name OK\n");
    2d68:	c7 44 24 04 fa 53 00 	movl   $0x53fa,0x4(%esp)
    2d6f:	00 
    2d70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d77:	e8 53 10 00 00       	call   3dcf <printf>
}
    2d7c:	c9                   	leave  
    2d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2d84:	c7 44 24 04 0e 54 00 	movl   $0x540e,0x4(%esp)
    2d8b:	00 
    2d8c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d93:	e8 37 10 00 00       	call   3dcf <printf>
    ...
    2db5:	e8 6e 0e 00 00       	call   3c28 <exit>
{
  ...
  if(n == 1000){
    ...
    2dd3:	c7 44 24 04 1c 54 00 	movl   $0x541c,0x4(%esp)
    2dda:	00 
    2ddb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2de2:	e8 e8 0f 00 00       	call   3dcf <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2df5:	c7 44 24 04 3e 54 00 	movl   $0x543e,0x4(%esp)
    2dfc:	00 
    2dfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e04:	e8 c6 0f 00 00       	call   3dcf <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2e22:	c7 44 24 04 52 54 00 	movl   $0x5452,0x4(%esp)
    2e29:	00 
    2e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e31:	e8 99 0f 00 00       	call   3dcf <printf>
    exit();
    2e36:	e8 ed 0d 00 00       	call   3c28 <exit>
  }
  
  printf(1, "fork test OK\n");
    2e3b:	c7 44 24 04 65 54 00 	movl   $0x5465,0x4(%esp)
    2e42:	00 
    2e43:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e4a:	e8 80 0f 00 00       	call   3dcf <printf>
}
    2e4f:	c9                   	leave  
    2e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2e5b:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    2e60:	c7 44 24 04 73 54 00 	movl   $0x5473,0x4(%esp)
    2e67:	00 
    2e68:	89 04 24             	mov    %eax,(%esp)
    2e6b:	e8 5f 0f 00 00       	call   3dcf <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    2eae:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    ...
    2ec8:	c7 44 24 04 7e 54 00 	movl   $0x547e,0x4(%esp)
    2ecf:	00 
    2ed0:	89 04 24             	mov    %eax,(%esp)
    2ed3:	e8 f7 0e 00 00       	call   3dcf <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2f07:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    2f0c:	c7 44 24 04 99 54 00 	movl   $0x5499,0x4(%esp)
    2f13:	00 
    2f14:	89 04 24             	mov    %eax,(%esp)
    2f17:	e8 b3 0e 00 00       	call   3dcf <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2f4a:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    2f4f:	c7 44 24 04 b0 54 00 	movl   $0x54b0,0x4(%esp)
    2f56:	00 
    2f57:	89 04 24             	mov    %eax,(%esp)
    2f5a:	e8 70 0e 00 00       	call   3dcf <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    2faa:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    2faf:	c7 44 24 04 cc 54 00 	movl   $0x54cc,0x4(%esp)
    2fb6:	00 
    2fb7:	89 04 24             	mov    %eax,(%esp)
    2fba:	e8 10 0e 00 00       	call   3dcf <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ff5:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    2ffa:	c7 44 24 04 0a 55 00 	movl   $0x550a,0x4(%esp)
    3001:	00 
    3002:	89 04 24             	mov    %eax,(%esp)
    3005:	e8 c5 0d 00 00       	call   3dcf <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    302b:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    ...
    303e:	c7 44 24 04 28 55 00 	movl   $0x5528,0x4(%esp)
    3045:	00 
    3046:	89 04 24             	mov    %eax,(%esp)
    3049:	e8 81 0d 00 00       	call   3dcf <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3092:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    ...
    30a5:	c7 44 24 04 60 55 00 	movl   $0x5560,0x4(%esp)
    30ac:	00 
    30ad:	89 04 24             	mov    %eax,(%esp)
    30b0:	e8 1a 0d 00 00       	call   3dcf <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    30c4:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    30c9:	c7 44 24 04 88 55 00 	movl   $0x5588,0x4(%esp)
    30d0:	00 
    30d1:	89 04 24             	mov    %eax,(%esp)
    30d4:	e8 f6 0c 00 00       	call   3dcf <printf>
    exit();
  ...
  if(c != a){
    ...
    3115:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    ...
    3128:	c7 44 24 04 b8 55 00 	movl   $0x55b8,0x4(%esp)
    312f:	00 
    3130:	89 04 24             	mov    %eax,(%esp)
    3133:	e8 97 0c 00 00       	call   3dcf <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    315c:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3161:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
    3168:	00 
    3169:	89 04 24             	mov    %eax,(%esp)
    316c:	e8 5e 0c 00 00       	call   3dcf <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    31dd:	c7 44 24 04 d5 44 00 	movl   $0x44d5,0x4(%esp)
    31e4:	00 
    31e5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    31ec:	e8 de 0b 00 00       	call   3dcf <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3242:	00 
    3243:	c7 44 24 04 3a 45 00 	movl   $0x453a,0x4(%esp)
    324a:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    32e4:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    32e9:	c7 44 24 04 f2 55 00 	movl   $0x55f2,0x4(%esp)
    32f0:	00 
    32f1:	89 04 24             	mov    %eax,(%esp)
    32f4:	e8 d6 0a 00 00       	call   3dcf <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    332c:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3331:	c7 44 24 04 0d 56 00 	movl   $0x560d,0x4(%esp)
    3338:	00 
    3339:	89 04 24             	mov    %eax,(%esp)
    333c:	e8 8e 0a 00 00       	call   3dcf <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    337b:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3380:	c7 44 24 04 1b 56 00 	movl   $0x561b,0x4(%esp)
    3387:	00 
    3388:	89 04 24             	mov    %eax,(%esp)
    338b:	e8 3f 0a 00 00       	call   3dcf <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    33ed:	c7 04 24 2a 56 00 00 	movl   $0x562a,(%esp)
    33f4:	e8 8f 08 00 00       	call   3c88 <link>
    33f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    33fc:	74 1a                	je     3418 <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    33fe:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3403:	c7 44 24 04 35 56 00 	movl   $0x5635,0x4(%esp)
    340a:	00 
    340b:	89 04 24             	mov    %eax,(%esp)
    340e:	e8 bc 09 00 00       	call   3dcf <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    342b:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3430:	c7 44 24 04 4e 56 00 	movl   $0x564e,0x4(%esp)
    3437:	00 
    3438:	89 04 24             	mov    %eax,(%esp)
    343b:	e8 8f 09 00 00       	call   3dcf <printf>
}
    3440:	c9                   	leave  
    3441:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3448:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    344d:	c7 44 24 04 5b 56 00 	movl   $0x565b,0x4(%esp)
    3454:	00 
    3455:	89 04 24             	mov    %eax,(%esp)
    3458:	e8 72 09 00 00       	call   3dcf <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3475:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    347a:	c7 44 24 04 65 56 00 	movl   $0x5665,0x4(%esp)
    3481:	00 
    3482:	89 04 24             	mov    %eax,(%esp)
    3485:	e8 45 09 00 00       	call   3dcf <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    349d:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    34a2:	c7 44 24 04 76 56 00 	movl   $0x5676,0x4(%esp)
    34a9:	00 
    34aa:	89 04 24             	mov    %eax,(%esp)
    34ad:	e8 1d 09 00 00       	call   3dcf <printf>
}
    34b2:	c9                   	leave  
    34b3:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    34ba:	c7 04 24 83 56 00 00 	movl   $0x5683,(%esp)
  ...
  if(pid == 0){
    ...
    34e4:	c7 04 85 20 5f 00 00 	movl   $0x5690,0x5f20(,%eax,4)
    34eb:	90 56 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3503:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3508:	c7 44 24 04 6d 57 00 	movl   $0x576d,0x4(%esp)
    350f:	00 
    3510:	89 04 24             	mov    %eax,(%esp)
    3513:	e8 b7 08 00 00       	call   3dcf <printf>
    exec("echo", args);
    3518:	c7 44 24 04 20 5f 00 	movl   $0x5f20,0x4(%esp)
    351f:	00 
    3520:	c7 04 24 94 41 00 00 	movl   $0x4194,(%esp)
    3527:	e8 34 07 00 00       	call   3c60 <exec>
    printf(stdout, "bigarg test ok\n");
    352c:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3531:	c7 44 24 04 7a 57 00 	movl   $0x577a,0x4(%esp)
    3538:	00 
    3539:	89 04 24             	mov    %eax,(%esp)
    353c:	e8 8e 08 00 00       	call   3dcf <printf>
    fd = open("bigarg-ok", O_CREATE);
    3541:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    3548:	00 
    3549:	c7 04 24 83 56 00 00 	movl   $0x5683,(%esp)
    ...
    356e:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    3573:	c7 44 24 04 8a 57 00 	movl   $0x578a,0x4(%esp)
    357a:	00 
    357b:	89 04 24             	mov    %eax,(%esp)
    357e:	e8 4c 08 00 00       	call   3dcf <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3594:	00 
    3595:	c7 04 24 83 56 00 00 	movl   $0x5683,(%esp)
  ...
  if(fd < 0){
    ...
    35aa:	a1 ec 5e 00 00       	mov    0x5eec,%eax
    35af:	c7 44 24 04 a3 57 00 	movl   $0x57a3,0x4(%esp)
    35b6:	00 
    35b7:	89 04 24             	mov    %eax,(%esp)
    35ba:	e8 10 08 00 00       	call   3dcf <printf>
    exit();
  ...
  unlink("bigarg-ok");
    35cf:	c7 04 24 83 56 00 00 	movl   $0x5683,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    35eb:	c7 44 24 04 b8 57 00 	movl   $0x57b8,0x4(%esp)
    35f2:	00 
    35f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35fa:	e8 d0 07 00 00       	call   3dcf <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    36db:	c7 44 24 04 c5 57 00 	movl   $0x57c5,0x4(%esp)
    36e2:	00 
    36e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    36ea:	e8 e0 06 00 00       	call   3dcf <printf>
    ...
    3712:	c7 44 24 04 d1 57 00 	movl   $0x57d1,0x4(%esp)
    3719:	00 
    371a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3721:	e8 a9 06 00 00       	call   3dcf <printf>
      break;
    ...
    376a:	c7 44 24 04 e1 57 00 	movl   $0x57e1,0x4(%esp)
    3771:	00 
    3772:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3779:	e8 51 06 00 00       	call   3dcf <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3885:	c7 44 24 04 f1 57 00 	movl   $0x57f1,0x4(%esp)
    388c:	00 
    388d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3894:	e8 36 05 00 00       	call   3dcf <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    38a2:	a1 f0 5e 00 00       	mov    0x5ef0,%eax
    38a7:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    38ad:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    38b2:	a3 f0 5e 00 00       	mov    %eax,0x5ef0
  return randstate;
    38b7:	a1 f0 5e 00 00       	mov    0x5ef0,%eax
}
    38bc:	5d                   	pop    %ebp
    38bd:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3913:	00 
    3914:	c7 04 24 1b 58 00 00 	movl   $0x581b,(%esp)
...
putc(int fd, char c)
{
    ...
    3cfb:	83 ec 28             	sub    $0x28,%esp
    3cfe:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d01:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3d04:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3d0b:	00 
    3d0c:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3d0f:	89 44 24 04          	mov    %eax,0x4(%esp)
    3d13:	8b 45 08             	mov    0x8(%ebp),%eax
    3d16:	89 04 24             	mov    %eax,(%esp)
    3d19:	e8 2a ff ff ff       	call   3c48 <write>
}
    3d1e:	c9                   	leave  
    3d1f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3d26:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3d2d:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3d31:	74 17                	je     3d4a <printint+0x2a>
    3d33:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3d37:	79 11                	jns    3d4a <printint+0x2a>
    neg = 1;
    3d39:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3d40:	8b 45 0c             	mov    0xc(%ebp),%eax
    3d43:	f7 d8                	neg    %eax
    3d45:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d48:	eb 06                	jmp    3d50 <printint+0x30>
  } else {
    x = xx;
    3d4a:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  do{
    buf[i++] = digits[x % base];
    3d57:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3d5a:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d5d:	ba 00 00 00 00       	mov    $0x0,%edx
    3d62:	f7 f1                	div    %ecx
    3d64:	89 d0                	mov    %edx,%eax
    3d66:	0f b6 90 f4 5e 00 00 	movzbl 0x5ef4(%eax),%edx
    3d6d:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d70:	03 45 f4             	add    -0xc(%ebp),%eax
    3d73:	88 10                	mov    %dl,(%eax)
    3d75:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    3d79:	8b 55 10             	mov    0x10(%ebp),%edx
    3d7c:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    3d7f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3d82:	ba 00 00 00 00       	mov    $0x0,%edx
    3d87:	f7 75 d4             	divl   -0x2c(%ebp)
    3d8a:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3d8d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3d91:	75 c4                	jne    3d57 <printint+0x37>
  if(neg)
    3d93:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    3d97:	74 2a                	je     3dc3 <printint+0xa3>
    buf[i++] = '-';
    3d99:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3d9c:	03 45 f4             	add    -0xc(%ebp),%eax
    3d9f:	c6 00 2d             	movb   $0x2d,(%eax)
    3da2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    3da6:	eb 1b                	jmp    3dc3 <printint+0xa3>
    putc(fd, buf[i]);
    3da8:	8d 45 dc             	lea    -0x24(%ebp),%eax
    3dab:	03 45 f4             	add    -0xc(%ebp),%eax
    3dae:	0f b6 00             	movzbl (%eax),%eax
    3db1:	0f be c0             	movsbl %al,%eax
    3db4:	89 44 24 04          	mov    %eax,0x4(%esp)
    3db8:	8b 45 08             	mov    0x8(%ebp),%eax
    3dbb:	89 04 24             	mov    %eax,(%esp)
    3dbe:	e8 35 ff ff ff       	call   3cf8 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    3dc3:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    3dc7:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3dcb:	79 db                	jns    3da8 <printint+0x88>
    putc(fd, buf[i]);
}
    3dcd:	c9                   	leave  
    3dce:	c3                   	ret    
...
{
    3dcf:	55                   	push   %ebp
    3dd0:	89 e5                	mov    %esp,%ebp
    3dd2:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    3dd5:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    3ddc:	8d 45 0c             	lea    0xc(%ebp),%eax
    3ddf:	83 c0 04             	add    $0x4,%eax
    3de2:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    3de5:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    3dec:	e9 7d 01 00 00       	jmp    3f6e <printf+0x19f>
    c = fmt[i] & 0xff;
    3df1:	8b 55 0c             	mov    0xc(%ebp),%edx
    3df4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3df7:	01 d0                	add    %edx,%eax
    3df9:	0f b6 00             	movzbl (%eax),%eax
    3dfc:	0f be c0             	movsbl %al,%eax
    3dff:	25 ff 00 00 00       	and    $0xff,%eax
    3e04:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    3e07:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    3e0b:	75 2c                	jne    3e39 <printf+0x6a>
      if(c == '%'){
    3e0d:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3e11:	75 0c                	jne    3e1f <printf+0x50>
        state = '%';
    3e13:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    3e1a:	e9 4b 01 00 00       	jmp    3f6a <printf+0x19b>
      } else {
        putc(fd, c);
    3e1f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3e22:	0f be c0             	movsbl %al,%eax
    3e25:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e29:	8b 45 08             	mov    0x8(%ebp),%eax
    3e2c:	89 04 24             	mov    %eax,(%esp)
    3e2f:	e8 c4 fe ff ff       	call   3cf8 <putc>
    3e34:	e9 31 01 00 00       	jmp    3f6a <printf+0x19b>
      }
    } else if(state == '%'){
    3e39:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    3e3d:	0f 85 27 01 00 00    	jne    3f6a <printf+0x19b>
      if(c == 'd'){
    3e43:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    3e47:	75 2d                	jne    3e76 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    3e49:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e4c:	8b 00                	mov    (%eax),%eax
    3e4e:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    3e55:	00 
    3e56:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    3e5d:	00 
    3e5e:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e62:	8b 45 08             	mov    0x8(%ebp),%eax
    3e65:	89 04 24             	mov    %eax,(%esp)
    3e68:	e8 b3 fe ff ff       	call   3d20 <printint>
        ap++;
    3e6d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3e71:	e9 ed 00 00 00       	jmp    3f63 <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    3e76:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    3e7a:	74 06                	je     3e82 <printf+0xb3>
    3e7c:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    3e80:	75 2d                	jne    3eaf <printf+0xe0>
        printint(fd, *ap, 16, 0);
    3e82:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3e85:	8b 00                	mov    (%eax),%eax
    3e87:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    3e8e:	00 
    3e8f:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    3e96:	00 
    3e97:	89 44 24 04          	mov    %eax,0x4(%esp)
    3e9b:	8b 45 08             	mov    0x8(%ebp),%eax
    3e9e:	89 04 24             	mov    %eax,(%esp)
    3ea1:	e8 7a fe ff ff       	call   3d20 <printint>
        ap++;
    3ea6:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3eaa:	e9 b4 00 00 00       	jmp    3f63 <printf+0x194>
      } else if(c == 's'){
    3eaf:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    3eb3:	75 46                	jne    3efb <printf+0x12c>
        s = (char*)*ap;
    3eb5:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3eb8:	8b 00                	mov    (%eax),%eax
    3eba:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    3ebd:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    3ec1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    3ec5:	75 27                	jne    3eee <printf+0x11f>
          s = "(null)";
    3ec7:	c7 45 f4 56 58 00 00 	movl   $0x5856,-0xc(%ebp)
        while(*s != 0){
    3ece:	eb 1e                	jmp    3eee <printf+0x11f>
          putc(fd, *s);
    ...
    3ee3:	e8 10 fe ff ff       	call   3cf8 <putc>
          s++;
    3ee8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    3eec:	eb 01                	jmp    3eef <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    3ef2:	0f b6 00             	movzbl (%eax),%eax
    3ef5:	84 c0                	test   %al,%al
    3ef7:	75 d7                	jne    3ed0 <printf+0x101>
    3ef9:	eb 68                	jmp    3f63 <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    3efb:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    3eff:	75 1d                	jne    3f1e <printf+0x14f>
        putc(fd, *ap);
    3f01:	8b 45 e8             	mov    -0x18(%ebp),%eax
    3f04:	8b 00                	mov    (%eax),%eax
    3f06:	0f be c0             	movsbl %al,%eax
    3f09:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f0d:	8b 45 08             	mov    0x8(%ebp),%eax
    3f10:	89 04 24             	mov    %eax,(%esp)
    3f13:	e8 e0 fd ff ff       	call   3cf8 <putc>
        ap++;
    3f18:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    3f1c:	eb 45                	jmp    3f63 <printf+0x194>
      } else if(c == '%'){
    3f1e:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    3f22:	75 17                	jne    3f3b <printf+0x16c>
        putc(fd, c);
    3f24:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f27:	0f be c0             	movsbl %al,%eax
    3f2a:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f2e:	8b 45 08             	mov    0x8(%ebp),%eax
    3f31:	89 04 24             	mov    %eax,(%esp)
    3f34:	e8 bf fd ff ff       	call   3cf8 <putc>
    3f39:	eb 28                	jmp    3f63 <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    3f3b:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    3f42:	00 
    3f43:	8b 45 08             	mov    0x8(%ebp),%eax
    3f46:	89 04 24             	mov    %eax,(%esp)
    3f49:	e8 aa fd ff ff       	call   3cf8 <putc>
        putc(fd, c);
    3f4e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3f51:	0f be c0             	movsbl %al,%eax
    3f54:	89 44 24 04          	mov    %eax,0x4(%esp)
    3f58:	8b 45 08             	mov    0x8(%ebp),%eax
    3f5b:	89 04 24             	mov    %eax,(%esp)
    3f5e:	e8 95 fd ff ff       	call   3cf8 <putc>
      }
      state = 0;
    3f63:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3f6a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    3f6e:	8b 55 0c             	mov    0xc(%ebp),%edx
    3f71:	8b 45 f0             	mov    -0x10(%ebp),%eax
    3f74:	01 d0                	add    %edx,%eax
    3f76:	0f b6 00             	movzbl (%eax),%eax
    3f79:	84 c0                	test   %al,%al
    3f7b:	0f 85 70 fe ff ff    	jne    3df1 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3fc1:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fc4:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    3fc7:	76 d4                	jbe    3f9d <free+0x19>
    3fc9:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fcc:	8b 00                	mov    (%eax),%eax
    3fce:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    3fd1:	76 ca                	jbe    3f9d <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    3fd3:	8b 45 f8             	mov    -0x8(%ebp),%eax
    3fd6:	8b 40 04             	mov    0x4(%eax),%eax
    3fd9:	c1 e0 03             	shl    $0x3,%eax
    3fdc:	89 c2                	mov    %eax,%edx
    3fde:	03 55 f8             	add    -0x8(%ebp),%edx
    3fe1:	8b 45 fc             	mov    -0x4(%ebp),%eax
    3fe4:	8b 00                	mov    (%eax),%eax
    3fe6:	39 c2                	cmp    %eax,%edx
    3fe8:	75 24                	jne    400e <free+0x8a>
  ...
  if(p + p->s.size == bp){
    ...
    401e:	c1 e0 03             	shl    $0x3,%eax
    4021:	03 45 fc             	add    -0x4(%ebp),%eax
    4024:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4027:	75 20                	jne    4049 <free+0xc5>
    p->s.size += bp->s.size;
    4029:	8b 45 fc             	mov    -0x4(%ebp),%eax
    402c:	8b 50 04             	mov    0x4(%eax),%edx
    402f:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4032:	8b 40 04             	mov    0x4(%eax),%eax
    4035:	01 c2                	add    %eax,%edx
    4037:	8b 45 fc             	mov    -0x4(%ebp),%eax
    403a:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    403d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4040:	8b 10                	mov    (%eax),%edx
    4042:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4045:	89 10                	mov    %edx,(%eax)
    4047:	eb 08                	jmp    4051 <free+0xcd>
  } else
    p->s.ptr = bp;
    4049:	8b 45 fc             	mov    -0x4(%ebp),%eax
    404c:	8b 55 f8             	mov    -0x8(%ebp),%edx
    404f:	89 10                	mov    %edx,(%eax)
  freep = p;
    4051:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4054:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
}
    4059:	c9                   	leave  
    405a:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    405e:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    4061:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4068:	77 07                	ja     4071 <morecore+0x16>
    nu = 4096;
    406a:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    4071:	8b 45 08             	mov    0x8(%ebp),%eax
    4074:	c1 e0 03             	shl    $0x3,%eax
    4077:	89 04 24             	mov    %eax,(%esp)
    407a:	e8 31 fc ff ff       	call   3cb0 <sbrk>
    407f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4082:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4086:	75 07                	jne    408f <morecore+0x34>
    return 0;
    4088:	b8 00 00 00 00       	mov    $0x0,%eax
    408d:	eb 22                	jmp    40b1 <morecore+0x56>
  hp = (Header*)p;
    408f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4092:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4095:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4098:	8b 55 08             	mov    0x8(%ebp),%edx
    409b:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    409e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40a1:	83 c0 08             	add    $0x8,%eax
    40a4:	89 04 24             	mov    %eax,(%esp)
    40a7:	e8 d8 fe ff ff       	call   3f84 <free>
  return freep;
    40ac:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
}
    40b1:	c9                   	leave  
    40b2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    40bc:	83 c0 07             	add    $0x7,%eax
    40bf:	c1 e8 03             	shr    $0x3,%eax
    40c2:	83 c0 01             	add    $0x1,%eax
    40c5:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    40c8:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    40cd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    40d0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    40d4:	75 23                	jne    40f9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    40d6:	c7 45 f0 a0 5f 00 00 	movl   $0x5fa0,-0x10(%ebp)
    40dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40e0:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
    40e5:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    40ea:	a3 a0 5f 00 00       	mov    %eax,0x5fa0
    base.s.size = 0;
    40ef:	c7 05 a4 5f 00 00 00 	movl   $0x0,0x5fa4
    40f6:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    40f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40fc:	8b 00                	mov    (%eax),%eax
    40fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    4101:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4104:	8b 40 04             	mov    0x4(%eax),%eax
    4107:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    410a:	72 4d                	jb     4159 <malloc+0xa6>
      if(p->s.size == nunits)
    410c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    410f:	8b 40 04             	mov    0x4(%eax),%eax
    4112:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4115:	75 0c                	jne    4123 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    4117:	8b 45 f4             	mov    -0xc(%ebp),%eax
    411a:	8b 10                	mov    (%eax),%edx
    411c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    411f:	89 10                	mov    %edx,(%eax)
    4121:	eb 26                	jmp    4149 <malloc+0x96>
      else {
        p->s.size -= nunits;
    4123:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4126:	8b 40 04             	mov    0x4(%eax),%eax
    4129:	89 c2                	mov    %eax,%edx
    412b:	2b 55 ec             	sub    -0x14(%ebp),%edx
    412e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4131:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    4134:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4137:	8b 40 04             	mov    0x4(%eax),%eax
    413a:	c1 e0 03             	shl    $0x3,%eax
    413d:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    4140:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4143:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4146:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4149:	8b 45 f0             	mov    -0x10(%ebp),%eax
    414c:	a3 a8 5f 00 00       	mov    %eax,0x5fa8
      return (void*)(p + 1);
    4151:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4154:	83 c0 08             	add    $0x8,%eax
    4157:	eb 38                	jmp    4191 <malloc+0xde>
    }
    if(p == freep)
    4159:	a1 a8 5f 00 00       	mov    0x5fa8,%eax
    415e:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4161:	75 1b                	jne    417e <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4163:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4166:	89 04 24             	mov    %eax,(%esp)
    4169:	e8 ed fe ff ff       	call   405b <morecore>
    416e:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4171:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4175:	75 07                	jne    417e <malloc+0xcb>
        return 0;
    4177:	b8 00 00 00 00       	mov    $0x0,%eax
    417c:	eb 13                	jmp    4191 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4187:	8b 00                	mov    (%eax),%eax
    4189:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    418c:	e9 70 ff ff ff       	jmp    4101 <malloc+0x4e>
}
    4191:	c9                   	leave  
    4192:	c3                   	ret    
