...
runcmd(struct cmd *cmd)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      76:	e8 8c 10 00 00       	call   1107 <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      c9:	e8 39 10 00 00       	call   1107 <printf>
      exit();
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 10 15 00 	movl   $0x1510,0x4(%esp)
     216:	00 
     217:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     21e:	e8 e4 0e 00 00       	call   1107 <printf>
  memset(buf, 0, nbuf);
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 13 15 00 00 	movl   $0x1513,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     2fd:	00 
     2fe:	c7 44 24 04 1b 15 00 	movl   $0x151b,0x4(%esp)
     305:	00 
     306:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     30d:	e8 f5 0d 00 00       	call   1107 <printf>
      continue;
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 29 15 00 	movl   $0x1529,0x4(%esp)
     36e:	00 
     36f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     376:	e8 8c 0d 00 00       	call   1107 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 2d 15 00 00 	movl   $0x152d,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b2:	e8 34 10 00 00       	call   13eb <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3f0:	e8 f6 0f 00 00       	call   13eb <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     45b:	e8 8b 0f 00 00       	call   13eb <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4ab:	e8 3b 0f 00 00       	call   13eb <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4fb:	e8 eb 0e 00 00       	call   13eb <malloc>
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 3c 1a 00 00 	movl   $0x1a3c,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 3c 1a 00 00 	movl   $0x1a3c,(%esp)
     ...
     61e:	c7 04 24 42 1a 00 00 	movl   $0x1a42,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 3c 1a 00 00 	movl   $0x1a3c,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 3c 1a 00 00 	movl   $0x1a3c,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 32 15 00 	movl   $0x1532,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 33 15 00 	movl   $0x1533,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 a9 09 00 00       	call   1107 <printf>
    panic("syntax");
     75e:	c7 04 24 42 15 00 00 	movl   $0x1542,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 49 15 00 	movl   $0x1549,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 4b 15 00 	movl   $0x154b,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 4d 15 00 	movl   $0x154d,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 4f 15 00 00 	movl   $0x154f,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 6c 15 00 	movl   $0x156c,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 6f 15 00 	movl   $0x156f,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 71 15 00 00 	movl   $0x1571,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 7c 15 00 	movl   $0x157c,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 7e 15 00 00 	movl   $0x157e,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 6f 15 00 	movl   $0x156f,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 42 15 00 00 	movl   $0x1542,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 91 15 00 00 	movl   $0x1591,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 9f 15 00 	movl   $0x159f,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 a4 15 00 00 	mov    0x15a4(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
    ...
    1033:	83 ec 28             	sub    $0x28,%esp
    1036:	8b 45 0c             	mov    0xc(%ebp),%eax
    1039:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    103c:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    1043:	00 
    1044:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1047:	89 44 24 04          	mov    %eax,0x4(%esp)
    104b:	8b 45 08             	mov    0x8(%ebp),%eax
    104e:	89 04 24             	mov    %eax,(%esp)
    1051:	e8 2a ff ff ff       	call   f80 <write>
}
    1056:	c9                   	leave  
    1057:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    1065:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    1069:	74 17                	je     1082 <printint+0x2a>
    106b:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    106f:	79 11                	jns    1082 <printint+0x2a>
    neg = 1;
    1071:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    1078:	8b 45 0c             	mov    0xc(%ebp),%eax
    107b:	f7 d8                	neg    %eax
    107d:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1080:	eb 06                	jmp    1088 <printint+0x30>
  } else {
    x = xx;
  ...
  do{
    ...
    109e:	0f b6 90 4c 1a 00 00 	movzbl 0x1a4c(%eax),%edx
    10a5:	8d 45 dc             	lea    -0x24(%ebp),%eax
    10a8:	03 45 f4             	add    -0xc(%ebp),%eax
    10ab:	88 10                	mov    %dl,(%eax)
    10ad:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  }while((x /= base) != 0);
    10b1:	8b 55 10             	mov    0x10(%ebp),%edx
    10b4:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    10b7:	8b 45 ec             	mov    -0x14(%ebp),%eax
    10ba:	ba 00 00 00 00       	mov    $0x0,%edx
    10bf:	f7 75 d4             	divl   -0x2c(%ebp)
    10c2:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10c5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    10c9:	75 c4                	jne    108f <printint+0x37>
  if(neg)
    10cb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    10cf:	74 2a                	je     10fb <printint+0xa3>
    buf[i++] = '-';
    10d1:	8d 45 dc             	lea    -0x24(%ebp),%eax
    10d4:	03 45 f4             	add    -0xc(%ebp),%eax
    10d7:	c6 00 2d             	movb   $0x2d,(%eax)
    10da:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)

  while(--i >= 0)
    10de:	eb 1b                	jmp    10fb <printint+0xa3>
    putc(fd, buf[i]);
    10e0:	8d 45 dc             	lea    -0x24(%ebp),%eax
    10e3:	03 45 f4             	add    -0xc(%ebp),%eax
    ...
    10f6:	e8 35 ff ff ff       	call   1030 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    ...
    1103:	79 db                	jns    10e0 <printint+0x88>
    putc(fd, buf[i]);
}
    1105:	c9                   	leave  
    1106:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    110a:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    110d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    1114:	8d 45 0c             	lea    0xc(%ebp),%eax
    1117:	83 c0 04             	add    $0x4,%eax
    111a:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    111d:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1124:	e9 7d 01 00 00       	jmp    12a6 <printf+0x19f>
    c = fmt[i] & 0xff;
    1129:	8b 55 0c             	mov    0xc(%ebp),%edx
    112c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    112f:	01 d0                	add    %edx,%eax
    1131:	0f b6 00             	movzbl (%eax),%eax
    1134:	0f be c0             	movsbl %al,%eax
    1137:	25 ff 00 00 00       	and    $0xff,%eax
    113c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    113f:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1143:	75 2c                	jne    1171 <printf+0x6a>
      if(c == '%'){
    1145:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1149:	75 0c                	jne    1157 <printf+0x50>
        state = '%';
    114b:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1152:	e9 4b 01 00 00       	jmp    12a2 <printf+0x19b>
      } else {
        putc(fd, c);
    1157:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    115a:	0f be c0             	movsbl %al,%eax
    115d:	89 44 24 04          	mov    %eax,0x4(%esp)
    1161:	8b 45 08             	mov    0x8(%ebp),%eax
    1164:	89 04 24             	mov    %eax,(%esp)
    1167:	e8 c4 fe ff ff       	call   1030 <putc>
    116c:	e9 31 01 00 00       	jmp    12a2 <printf+0x19b>
      }
    } else if(state == '%'){
    1171:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    1175:	0f 85 27 01 00 00    	jne    12a2 <printf+0x19b>
      if(c == 'd'){
    117b:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    117f:	75 2d                	jne    11ae <printf+0xa7>
        printint(fd, *ap, 10, 1);
    1181:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1184:	8b 00                	mov    (%eax),%eax
    1186:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    118d:	00 
    118e:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    1195:	00 
    1196:	89 44 24 04          	mov    %eax,0x4(%esp)
    119a:	8b 45 08             	mov    0x8(%ebp),%eax
    119d:	89 04 24             	mov    %eax,(%esp)
    11a0:	e8 b3 fe ff ff       	call   1058 <printint>
        ap++;
    11a5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11a9:	e9 ed 00 00 00       	jmp    129b <printf+0x194>
      } else if(c == 'x' || c == 'p'){
    11ae:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    11b2:	74 06                	je     11ba <printf+0xb3>
    11b4:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    11b8:	75 2d                	jne    11e7 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    11ba:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11bd:	8b 00                	mov    (%eax),%eax
    11bf:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    11c6:	00 
    11c7:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    11ce:	00 
    11cf:	89 44 24 04          	mov    %eax,0x4(%esp)
    11d3:	8b 45 08             	mov    0x8(%ebp),%eax
    11d6:	89 04 24             	mov    %eax,(%esp)
    11d9:	e8 7a fe ff ff       	call   1058 <printint>
        ap++;
    11de:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    11e2:	e9 b4 00 00 00       	jmp    129b <printf+0x194>
      } else if(c == 's'){
    11e7:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    11eb:	75 46                	jne    1233 <printf+0x12c>
        s = (char*)*ap;
    11ed:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11f0:	8b 00                	mov    (%eax),%eax
    11f2:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    11f5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    11f9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    11fd:	75 27                	jne    1226 <printf+0x11f>
          s = "(null)";
    11ff:	c7 45 f4 bc 15 00 00 	movl   $0x15bc,-0xc(%ebp)
        while(*s != 0){
    1206:	eb 1e                	jmp    1226 <printf+0x11f>
          putc(fd, *s);
    ...
    121b:	e8 10 fe ff ff       	call   1030 <putc>
          s++;
    1220:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
    1224:	eb 01                	jmp    1227 <printf+0x120>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    122f:	75 d7                	jne    1208 <printf+0x101>
    1231:	eb 68                	jmp    129b <printf+0x194>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1233:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1237:	75 1d                	jne    1256 <printf+0x14f>
        putc(fd, *ap);
    ...
    124b:	e8 e0 fd ff ff       	call   1030 <putc>
        ap++;
    1250:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1254:	eb 45                	jmp    129b <printf+0x194>
      } else if(c == '%'){
    1256:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    125a:	75 17                	jne    1273 <printf+0x16c>
        putc(fd, c);
    125c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    125f:	0f be c0             	movsbl %al,%eax
    1262:	89 44 24 04          	mov    %eax,0x4(%esp)
    1266:	8b 45 08             	mov    0x8(%ebp),%eax
    1269:	89 04 24             	mov    %eax,(%esp)
    126c:	e8 bf fd ff ff       	call   1030 <putc>
    1271:	eb 28                	jmp    129b <printf+0x194>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    1273:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    127a:	00 
    127b:	8b 45 08             	mov    0x8(%ebp),%eax
    127e:	89 04 24             	mov    %eax,(%esp)
    1281:	e8 aa fd ff ff       	call   1030 <putc>
        putc(fd, c);
    1286:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1289:	0f be c0             	movsbl %al,%eax
    128c:	89 44 24 04          	mov    %eax,0x4(%esp)
    1290:	8b 45 08             	mov    0x8(%ebp),%eax
    1293:	89 04 24             	mov    %eax,(%esp)
    1296:	e8 95 fd ff ff       	call   1030 <putc>
      }
      state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    12b3:	0f 85 70 fe ff ff    	jne    1129 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12cb:	a1 cc 1a 00 00       	mov    0x1acc,%eax
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    1399:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    13a0:	77 07                	ja     13a9 <morecore+0x16>
    nu = 4096;
    13a2:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    13a9:	8b 45 08             	mov    0x8(%ebp),%eax
    13ac:	c1 e0 03             	shl    $0x3,%eax
    13af:	89 04 24             	mov    %eax,(%esp)
    13b2:	e8 31 fc ff ff       	call   fe8 <sbrk>
    13b7:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    13ba:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    13be:	75 07                	jne    13c7 <morecore+0x34>
    return 0;
    13c0:	b8 00 00 00 00       	mov    $0x0,%eax
    13c5:	eb 22                	jmp    13e9 <morecore+0x56>
  hp = (Header*)p;
    13c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    13ca:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    13cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13d0:	8b 55 08             	mov    0x8(%ebp),%edx
    13d3:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    13d6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13d9:	83 c0 08             	add    $0x8,%eax
    13dc:	89 04 24             	mov    %eax,(%esp)
    13df:	e8 d8 fe ff ff       	call   12bc <free>
  return freep;
    13e4:	a1 cc 1a 00 00       	mov    0x1acc,%eax
}
    13e9:	c9                   	leave  
    13ea:	c3                   	ret    
...
{
    13eb:	55                   	push   %ebp
    13ec:	89 e5                	mov    %esp,%ebp
    13ee:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    13f1:	8b 45 08             	mov    0x8(%ebp),%eax
    13f4:	83 c0 07             	add    $0x7,%eax
    13f7:	c1 e8 03             	shr    $0x3,%eax
    13fa:	83 c0 01             	add    $0x1,%eax
    13fd:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1400:	a1 cc 1a 00 00       	mov    0x1acc,%eax
    1405:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1408:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    140c:	75 23                	jne    1431 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    140e:	c7 45 f0 c4 1a 00 00 	movl   $0x1ac4,-0x10(%ebp)
    1415:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1418:	a3 cc 1a 00 00       	mov    %eax,0x1acc
    141d:	a1 cc 1a 00 00       	mov    0x1acc,%eax
    1422:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
    base.s.size = 0;
    1427:	c7 05 c8 1a 00 00 00 	movl   $0x0,0x1ac8
    142e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    143f:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1442:	72 4d                	jb     1491 <malloc+0xa6>
      if(p->s.size == nunits)
    1444:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1447:	8b 40 04             	mov    0x4(%eax),%eax
    144a:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    144d:	75 0c                	jne    145b <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    144f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1452:	8b 10                	mov    (%eax),%edx
    1454:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1457:	89 10                	mov    %edx,(%eax)
    1459:	eb 26                	jmp    1481 <malloc+0x96>
      else {
        p->s.size -= nunits;
    145b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    145e:	8b 40 04             	mov    0x4(%eax),%eax
    1461:	89 c2                	mov    %eax,%edx
    1463:	2b 55 ec             	sub    -0x14(%ebp),%edx
    1466:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1469:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    146c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    146f:	8b 40 04             	mov    0x4(%eax),%eax
    1472:	c1 e0 03             	shl    $0x3,%eax
    1475:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    1478:	8b 45 f4             	mov    -0xc(%ebp),%eax
    147b:	8b 55 ec             	mov    -0x14(%ebp),%edx
    147e:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    1481:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1484:	a3 cc 1a 00 00       	mov    %eax,0x1acc
      return (void*)(p + 1);
    1489:	8b 45 f4             	mov    -0xc(%ebp),%eax
    148c:	83 c0 08             	add    $0x8,%eax
    148f:	eb 38                	jmp    14c9 <malloc+0xde>
    }
    if(p == freep)
    1491:	a1 cc 1a 00 00       	mov    0x1acc,%eax
    1496:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    1499:	75 1b                	jne    14b6 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    149b:	8b 45 ec             	mov    -0x14(%ebp),%eax
    149e:	89 04 24             	mov    %eax,(%esp)
    14a1:	e8 ed fe ff ff       	call   1393 <morecore>
    14a6:	89 45 f4             	mov    %eax,-0xc(%ebp)
    14a9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    14ad:	75 07                	jne    14b6 <malloc+0xcb>
        return 0;
    14af:	b8 00 00 00 00       	mov    $0x0,%eax
    14b4:	eb 13                	jmp    14c9 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14bf:	8b 00                	mov    (%eax),%eax
    14c1:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    14c4:	e9 70 ff ff ff       	jmp    1439 <malloc+0x4e>
}
    14c9:	c9                   	leave  
    14ca:	c3                   	ret    
